...
VALUES ( '2a0699f4-87fd-11ec-a8a3-0242ac120002','d483e432-87fc-11ec-a8a3-0242ac120002',1,'40d2786e-87fe-11ec-a8a3-0242ac120002','0');
...
-- condition 2-2
INSERT INTO rule_condition ( uuid, rule_group_uuid, left_id, operator_uuid, right_value)
VALUES ( '21cfe2de-8e39-4b7c-9219-1d67b18bd7d9','fa3cab3c-87fc-11ec-a8a3-0242ac120002',3,'059f977c-f2e7-4984-b103-b0e0652f518e','99');

INSERT INTO rule_condition_element ( id, code, name, return_type, description)
VALUES ( '3','testVar003','测试变量003','Number','测试变量003测试用');

INSERT INTO rule_condition_operator ( uuid, code, name, compare_type, description)
VALUES ( '059f977c-f2e7-4984-b103-b0e0652f518e','lt','小于','Number','数值测试用');

------- mock compiled script -----

INSERT INTO rule_compiled_script(rule_uuid, language, dialect, script, version)
VALUES ('96668402-87fc-11ec-a8a3-0242ac120002', 'java', 'MVEL', '( ruleConditionCalculator.calc("testVar001","gt","0",["leftReturnType":"Number","leftIdentifyType":"variable","operatorUUID":"40d2786e-87fe-11ec-a8a3-0242ac120002"]) ) && ( ruleConditionCalculator.calc("testVar002","contains","a",["leftReturnType":"List_String","leftIdentifyType":"variable","operatorUUID":"277a1ec0-87ff-11ec-a8a3-0242ac120002"]) || ruleConditionCalculator.calc("testVar003","lt","99",["leftReturnType":"Number","leftIdentifyType":"variable","operatorUUID":"059f977c-f2e7-4984-b103-b0e0652f518e"]) )', 1)
